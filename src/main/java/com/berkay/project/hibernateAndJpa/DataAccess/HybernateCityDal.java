...
@Repository
public class HybernateCityDal implements ICityDal{
	
	private EntityManager entitiyManager;
	
	
	@Autowired
	public HybernateCityDal(EntityManager entitiyManager) {
	...
	public void add(City city) {
		Session session = entitiyManager.unwrap(Session.class);
		//City te id vermezsek ekler verirsek var olana update yapar
